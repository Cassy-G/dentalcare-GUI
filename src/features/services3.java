 ...
 */
public class services3 extends javax.swing.JFrame {
    int xMouse, yMouse;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Dental Crown");
        bg.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 380, 130, 50));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/dcr (1).jpg"))); // NOI18N
        picPnl.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, 210));

        bg.add(picPnl, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 170, 270, 210));
        ...
        jLabel9.setText("Brace Consultation");
        bg.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 380, 160, 50));

        jLabel5.setFont(new java.awt.Font("Tw Cen MT", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 204));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-back-32.png"))); // NOI18N
        jLabel5.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel5MouseClicked(evt);
            }
        });
        bg.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 466, 140, 60));

        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/bc (2).jpg"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, 210));

        bg.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 170, 270, 210));
        ...
        bg.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 380, 270, 60));
        ...
        bg.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 380, 270, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(services3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
