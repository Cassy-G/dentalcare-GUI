...
private void initPlaceholder() {
    username.setText("Jane Doe"); 
    username.setForeground(Color.GRAY);

    email.setText("jane.doe@example.com"); 
    email.setForeground(Color.GRAY);

    contact.setText("+63 912 345 6789"); 
    ...
    cpass.setText("Re-enter Password123!");
    cpass.setForeground(Color.GRAY);
    cpass.setEchoChar((char) 0);

    // ✅ Add padding so text doesn’t touch the border
    addFieldPadding(username);
    addFieldPadding(email);
    addFieldPadding(contact);
    addFieldPadding(pass);
    addFieldPadding(cpass);
}

private void setupPlaceholderEvents() {
    setupTextPlaceholder(username, "Jane Doe");
    setupTextPlaceholder(contact, "+63 912 345 6789");
    setupTextPlaceholder(email, "jane.doe@example.com");
    setupPasswordPlaceholder(pass, "Password123!");
    setupPasswordPlaceholder(cpass, "Re-enter Password123!");
}

// Helper method to add left padding
private void addFieldPadding(JTextField field) {
    field.setBorder(BorderFactory.createCompoundBorder(
        field.getBorder(),
        BorderFactory.createEmptyBorder(0, 8, 0, 0) // top, left, bottom, right
    ));
}
...
private void setupPasswordPlaceholder(javax.swing.JPasswordField field, String text) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 290, -1, 20));
        ...
        jCheckBox1.setFont(new java.awt.Font("Tw Cen MT", 0, 14)); // NOI18N
        ...
        jPanel2.add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 350, 200, 30));

        cpass.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 110, -1, 20));
        ...
        jLabel14.setText("*");
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 40, 10, 20));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 0, 0));
        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel15.setText("*");
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 20, 30));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 0, 0));
        jLabel16.setText("*");
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 160, -1, 30));

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 0, 0));
        jLabel17.setText("*");
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 220, -1, 20));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 0, 0));
        jLabel18.setText("*");
        jPanel2.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(188, 280, 20, 30));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-back-to-30.png"))); // NOI18N
        jLabel13.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel13MouseClicked(evt);
            }
        });
        jPanel3.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 420, 60, 40));
